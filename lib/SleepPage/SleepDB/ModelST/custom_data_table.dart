...
/// multiple pages.
// Also suggest [ScrollingDataTable] once we have it.
///
/// See also:
///
...
class DataTable extends StatelessWidget {
  ...
  static const double _dataRowHeight = 27.0;
  static const double _tablePadding = 45.0;
  ...
  Widget _buildHeadingCell({
    ...
    label = Container(
      ...
      child: AnimatedDefaultTextStyle(
        style: TextStyle(
          //font family should match Theme; see https://github.com/flutter/flutter/issues/3116
  ...
  Widget _buildDataCell({
    ...
    label = Container(
      ...
      child: DefaultTextStyle(
        style: TextStyle(
          // font family should be Roboto; see https://github.com/flutter/flutter/issues/3116
          fontSize: 13.0,
          color: isLightTheme
...
class _SortArrowState extends State<_SortArrow> with TickerProviderStateMixin {
  ...
  void _resetOrientationAnimation(AnimationStatus status) {
    if (status == AnimationStatus.completed) {
      ...
      _orientationController.value = 0.0; // This triggers a pointless rebuild.
    }
  }
