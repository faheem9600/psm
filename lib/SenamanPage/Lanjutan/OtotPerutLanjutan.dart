...
import 'package:appsatb/SenamanPage/Lanjutan/OtotPerutLanjutanSedia.dart';
import 'package:appsatb/SenamanPage/LanjutanPage.dart';
import 'package:flutter/material.dart';

class OtotPerutLanjutan extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: new MyOtotPerutLanjutan(),
    );
  }
}

class MyOtotPerutLanjutan extends StatefulWidget {
  @override
  _MyOtotPerutLanjutanState createState() => _MyOtotPerutLanjutanState();
}

class _MyOtotPerutLanjutanState extends State<MyOtotPerutLanjutan> {
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
        title: Text('Otot Perut Lanjutan'),
  ...
  return ListView(
    children: <Widget>[
      ...
      ListTile(
        ...
        subtitle: Text('x 20'),
         onTap: () {
           ...
           showDialog(context: context, builder: (context) => SitUpDialog(
            title: "Sit Up",
            description:"Berbaring dengan tangan dilipat di belakang kepala Anda. Kemudian angkat badan bahagian atas Anda sejauh mungkin dari lantai "
            "Perlahan kembali ke posisi berbaring dan ulang semula gerakan."
            ,
          ));
      ...
      ListTile(
        ...
        title: Text('3. Papan Menyamping Kiri'),
        subtitle: Text('x 20'),
        onTap: () {
      ...
      ListTile(
        ...
        title: Text('4. Papan Menyamping Kanan'),
        subtitle: Text('x 20'),
        onTap: () {
      ...
      ListTile(
        ...
        title: Text('10. Push Up dan Pusingan'),
        subtitle: Text('x 24'),
        onTap: () {
      ...
      child: RaisedButton(
        ...
        onPressed: (){
          ...
          Navigator.of(context).push(MaterialPageRoute(
                  builder:(context) => OtotPerutLanjutanSedia(), ));
...
class SitUpDialog extends StatelessWidget {

  final String title, description, buttonText;
  final Image image;

  SitUpDialog({this.title, this.description, this.buttonText, this.image});
    ...
    return Stack(
      children: <Widget>[
        ...
        child: CircleAvatar(
          ...
          radius: 50,
          backgroundImage: AssetImage('images/senaman.gif'),
        ) 
        )
      ]
    );
